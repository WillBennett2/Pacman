...
void Pacman::LoadContent()
{
	...
	// Set wall positions
	_wallCoord[0]->leftX = wallArray[0][0];
	// Set Menu Paramters
...
{
	//left y x
	wallArray[0][0] = 0, wallArray[0][1]= 0, wallArray[0][3] = 21, wallArray[0][2]= Graphics::GetViewportWidth();
	wallArray[1][0]=21, wallArray[1][1]=32, wallArray[1][2]=21, wallArray[1][3]=272;
	wallArray[2][0]= Graphics::GetViewportWidth() - 32, wallArray[2][1]= Graphics::GetViewportWidth(), wallArray[2][2]=21, wallArray[2][3]=272;
	wallArray[3][0] = 32, wallArray[3][1] = 272, wallArray[3][2] = 350, wallArray[3][3] = 193;
...
bool Pacman::CheckWallCollision()
{
