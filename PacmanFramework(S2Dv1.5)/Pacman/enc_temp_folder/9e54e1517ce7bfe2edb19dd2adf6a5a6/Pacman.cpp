...
void Pacman::LoadContent()
{
	...
	for (int i = 0; i< GHOSTCOUNT; i++)
	{
		...
		case(0):
			...
			_ghosts[i]->position = new Vector2((453), 403);
			break;
		case(1):
			GhostTex->Load("Textures/Cyan.png", false);
			_ghosts[i]->position = new Vector2((475), (403));
			break;
		case(2):
			GhostTex->Load("Textures/Pink.png", false);
			_ghosts[i]->position = new Vector2((497), (403));
			break;
		case(3):
			GhostTex->Load("Textures/Orange.png", false);
			_ghosts[i]->position = new Vector2((519), (403));
			break;
		}
