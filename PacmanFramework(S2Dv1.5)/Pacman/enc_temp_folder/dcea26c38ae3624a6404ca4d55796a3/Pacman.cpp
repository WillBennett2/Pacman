...
void Pacman::LoadContent()
{
	...
	// Set wall positions
	_wallCoord[1]->leftX = wallArray[0][0];
	// Set Menu Paramters
...
{
	//left y x
	wallArray[0][0] = 0, wallArray[0][1]= Graphics::GetViewportWidth(), wallArray[0][0], wallArray[0][4]=21;
	wallArray[1][21], wallArray[1][32], wallArray[1][21], wallArray[1][272];
	wallArray[2][Graphics::GetViewportWidth()-32], wallArray[2][Graphics::GetViewportWidth()], wallArray[2][21], wallArray[2][272];
